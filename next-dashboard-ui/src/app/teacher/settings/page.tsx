...
export default function TeacherSettingsPage() {
  ...
  const handleChangePassword = () => {
    ...
    console.log('Change Password Clicked, userId:', currentUserId);
    if (currentUserId) {
              ...
              <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Receive updates about school activities</p>
                      </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Get notified when parents send you messages</p>
                      </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Class Notifications</h3>
                        <p className="text-gray-600 mt-1">Get alerts about class changes and announcements</p>
                      </div>
                      <div className="relative inline-flex h-8 w-14 items-center rounded-full bg-blue-500 cursor-pointer transition" onClick={() => {}}>
                        <div className="inline-flex h-6 w-6 transform rounded-full bg-white transition translate-x-7"></div>
                      </div>
