...
# Realtime profile for NPU/iGPU-class laptops.
...
$env:ANOMALY_FIGHT_ON_MARGIN = "0.06"
$env:ANOMALY_FIGHT_OFF_MARGIN = "0.12"
$env:ANOMALY_FIGHT_MIN_ON_FRAMES = "5"
$env:ANOMALY_FIGHT_MIN_OFF_FRAMES = "4"
...
Write-Host "Starting anomaly service with NPU realtime profile..." -ForegroundColor Cyan
Write-Host "If DirectML provider is installed, ONNX models will use it; otherwise CPU fallback is automatic." -ForegroundColor Yellow
