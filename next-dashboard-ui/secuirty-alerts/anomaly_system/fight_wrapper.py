...
class FightDetectionWrapper(BaseAnomalyWrapper):
    ...
    def preprocess(self, frame: np.ndarray, context: FrameContext, buffer: RollingFrameBuffer) -> Any:
        ...
        # Adjust only this method if the trained fight checkpoint expects a different
        # clip layout, normalization, or spatial size.
